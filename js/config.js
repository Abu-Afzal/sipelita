const CONFIG = {
    ...
    layananMadrasah: [
        ...
        { icon: '✒️', title: 'SIPENA', desc: 'Sistem Penilaian dan Absensi', color: '#22dae0', page: 'pages/sipena-modern.html' },
        ...
        { icon: '📚', title: 'BANK SOAL', desc: 'Sitem Ujian Online', color: '#81b927', page: 'pages/bank-soal.html', id: 'menu-bank-soal' },
